...
<!-- fullcalendar -->
<link rel="stylesheet" href="<%=ctx %>/static/css/fullcalendar/fullcalendar.css">
<!-- colpick -->
...
<!-- fullcalendar -->
<script src="<%=ctx %>/static/js/fullcalendar/fullcalendar.min.js"></script>
<!-- UEditor -->
<script src="<%=ctx %>/static/js/UEditor/ueditor.config.js"></script>
<script src="<%=ctx %>/static/js/UEditor/ueditor.all.js"></script>
<script src="<%=ctx %>/static/js/UEditor/lang/zh-cn/zh-cn.js"></script>
<!-- colpick -->
<script src="<%=ctx %>/static/js/colpick/colpick.js"></script>
<!-- jQueryPrint -->
